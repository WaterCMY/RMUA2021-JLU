...
public:
	...
	*/
	...
	/**
	* @brief Set the distance between gun and camera
	* @param gun_cam_distance: the distance between gun and camera
	*/
	void setGunCamDistance(double gun_cam_distance);
	...
	*/
    ...
    void solveAngles(Point2f target_point);
	...
	*/
    void getAngle(ArmorBox target, int & X, int  & Y, int  & Z);

    void getAngle(Point2f target_point, double &yaw, double &pitch);
    /**
