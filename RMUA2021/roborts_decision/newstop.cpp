...
//&& (blackboard_ptr_->IsMoreBulletThanMate() || blackboard_ptr_->IsMateDie())){  
    ...
    auto enemy_not_lost_condition_= std::make_shared<roborts_decision::PreconditionNode>("enemy_not_lost_condition_", blackboard_ptr_,
        ...
        auto centre_stop_condition_= std::make_shared<roborts_decision::PreconditionNode>("centre_stop_condition_", blackboard_ptr_,
        [&]() {
            if (blackboard_ptr_->GetRemainingTime()>=120){ 
                return true;
            } else {
                return false;
                }
        ...
        roborts_decision::AbortType::BOTH); 
        centre_stop_condition_->SetChild(follow_action_); 
    ...
    game_start_selector_->AddChildren(centre_stop_condition_);
