#ifndef ROBORTS_DECISION_ESCAPE_H
#define ROBORTS_DECISION_ESCAPE_H
#include <unistd.h>      
#include <ros/ros.h>
...
namespace roborts_decision{
    ...
    public:
        Escape(const Blackboard::Ptr &blackboard_ptr, GoalFactory::GoalFactoryPtr &goal_factory_ptr) :
            ActionNode::ActionNode("escape", blackboard_ptr), goal_factory_ptr_(goal_factory_ptr) {
