#ifndef ROBORTS_DECISION_SHOOTACTION_H
#define ROBORTS_DECISION_SHOOTACTION_H
#include <unistd.h>      
#include <ros/ros.h>
...
namespace roborts_decision{
    ...
    public:
        ShootAction(const Blackboard::Ptr &blackboard_ptr, GoalFactory::GoalFactoryPtr &goal_factory_ptr) :
            ActionNode::ActionNode("shoot", blackboard_ptr), goal_factory_ptr_(goal_factory_ptr) {
