...
class MutualBoard{
    ...
    private:
        ...
        bool gimbal_punish_;
        bool chassis_punish_;
        bool is_running_;
        Status_RunStatus status_;
    ...
    public:
        ...
        teammate_status_(Status_RunStatus::Status_RunStatus_CHASE)
        {
            ...
            // roborts_common::ReadProtoFromTextFile(file_name.c_str(), &topic);
            // 定义发布者和订阅者
            // local_name = topic.local_name();
            // remote_name = topic.remote_name();
        ...
        void MsgNeedSend(){
            ...
            bullets_ = blackboard_ptr_->GetRemainBullet();
            heat_ = blackboard_ptr_->GetRobotHeat();
