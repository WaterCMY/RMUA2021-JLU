...
#include"roborts_msgs/ShootSpeed.h"
...
class Gimbal: public Module {
 ...
 private:
   ...
   */
  void ROS_Init();
  //bool SetShootSpeedService(roborts_msgs::ShootSpeed::Request &req,roborts_msgs::ShootSpeed::Response &res);
    /**
   * @brief Control shoot speed in ROS
   * @param req Shoot speed control data as request
  ...
  ros::Subscriber    ros_sub_cmd_gimbal_angle_;
   ...
   ros::Publisher ros_pub_camera_ang_;
  ...
  //! ros service server for set shoot speed
  ros::ServiceServer ros_set_shoot_speed_;
  //!ros service client for reset fric
  //ros::ServiceClient ros_reset_fric_;
  //! ros gimbal tf
  geometry_msgs::TransformStamped gimbal_tf_;
  //! ros gimbal tf broadcaster
  tf::TransformBroadcaster        tf_broadcaster_;
  //control speed
  int shoot_speed = 1400;
  //roborts_msgs::FricWhl srv;
  //ros::ServiceClient ros_ctrl_fric_client_;
