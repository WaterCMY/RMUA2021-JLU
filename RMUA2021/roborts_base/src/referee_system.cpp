...
void RefereeSystem::GameEventCallback(const std::shared_ptr<roborts_sdk::cmd_game_event> raw_game_event){
  ...
  // ROS_INFO("game_zone_array && game_zone_array");
